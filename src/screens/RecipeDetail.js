    ...
    <SafeAreaView style={styles.safeArea}>
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.demoBadge}>
          <Text style={styles.demoBadgeText}>가짜 JSON 레시피</Text>
        </View>
        ...
        {typeof recipe.matchScore === 'number' ? (
          <View style={styles.matchBox}>
            <Text style={styles.matchTitle}>보유 재료 {recipe.matchScore}% 일치</Text>
        ...
        <View style={styles.sourceCard}>
          ...
          <Text style={styles.sourceNotice}>
            현재는 UI 확인용 가짜 출처입니다. 실제 서비스에서는 Agent가 확인한 원문 URL이 표시됩니다.
          </Text>
